...
def find_the_correctly_encrypted():
	...
	for cipher in ciphers: 
		try: 
			decrypted = decryptor.decrypt(base64.decodebytes(cipher))
			return decrypted
		except ValueError: 
			pass
...
def find_the_real_code():
	...
	with open('/Users/julienesbt/Documents/Etudes/Master/M2/S1/Introduction to Computer Security/Practices/Assignment week 12/my_friend_key.pub','r') as f: 
		public_key = RSA.import_key(f.read())

	for message in messages:
		message_hex = SHA256.new(message['text']).digest().hex()
...
print(find_the_real_code().decode())