...
# Import the RSA private key from a PEM file
f = open('/Users/julienesbt/Documents/Etudes/Master/M2/S1/Introduction to Computer Security/Practices/Assignment week 12/secret_key.pem','r')
# f = open('secret_key.pem','r')
private_key = RSA.import_key(f.read())

# Load the RSA public key
f = open('/Users/julienesbt/Documents/Etudes/Master/M2/S1/Introduction to Computer Security/Practices/Assignment week 12/my_friend_key.pub','r')
...
# List of messages and their signatures
messages = [
...
def decrypt_RSA(encrypted_message, d, n):
    '''Function to decrypt a message using RSA'''
    return pow(encrypted_message, d, n)

# # Test encrypt_RSA
# encrypted_message1 = encrypt_RSA(1412, e, n)
# print("Encrypted message 1 - 1412:", encrypted_message1)
# encrypted_message2 = encrypt_RSA(423523131313, e, n)
# print("Encrypted message 2 : 423523131313:", encrypted_message2)

# # Test decrypt_RSA
# decrypted_message1 = decrypt_RSA(encrypted_message1, d, n)
# print("Decrypted message 1 back:", decrypted_message1)
# decrypted_message2 = decrypt_RSA(encrypted_message2, d, n)
# print("Decrypted message 2 back:", decrypted_message2)
...
# Function to decrypt a base64 encoded string using RSA
...
# print(f"Decrypted Message: {find_the_correctly_encrypted()}")

################### 3 ###################

def find_the_real_code():
	for message in messages:
		message_hex = SHA512.new(message['text']).digest().hex()
		message_int = int(message_hex, 16)
		hash_hex = base64.decodebytes(message['signature']).hex()
		hash_int = int(hash_hex, 16)
		if message_int == encrypt_RSA(hash_int, public_key.e, public_key.n): 
			return message['text'].decode()

# # Print the valid message
# print(f"Valid message: {find_the_real_code()}")